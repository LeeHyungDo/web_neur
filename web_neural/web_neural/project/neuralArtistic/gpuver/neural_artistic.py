...
from web_neural.project.neuralArtistic.gpuver.matconvnet import vgg_net
from web_neural.project.neuralArtistic.gpuver.style_network import StyleNetwork
from web_neural.project.models import Conversegpu
from web_neural.settings import MEDIA_ROOT
...
def run(args):
    ...
    for i in range(args.iterations):
        ...
        condoc = Conversegpu(congpufile= '/' + file_path)
        condoc.save()
...
class Rungpu(threading.Thread):
    ...
    def __init__(self):
        ...
        self.output = 'outgpu.png'
        self.init = None
        self.init_noise = 0
        self.random_seed = None
        self.animation = 'media/gpuanimation'
        self.iterations = 300
        self.learn_rate= 2.0
    ...
    def run(self):
        print MEDIA_ROOT
        print 'GPU Start background run'  
        run(self)
        print 'GPU Finished background run'  
